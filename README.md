# create-vue 3.22.0 — WSC2026

A small, real **create-vue** application (version **3.22.0**), part of the WorldSkills 2026
...
Edit **the files under src/ (this project was generated by create-vue 3.22.0)** to change the app.
...
`src/assets/main.css`, already imported from `src/main.js`. The scaffold's `base.css` is left
byte-identical and pulled in with `@import './base.css' layer(base)`.
...
`@theme { … }` in `src/assets/main.css`. Docs: <https://tailwindcss.com/docs>
